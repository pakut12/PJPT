...
if ($_SESSION["status"] == "User") {
    ...
    if (isset($_GET['id'])) {
        if ($_GET["id"] == 1) {
            ...
            $pdf->Cell(8);
            $pdf->Cell(26, 10, iconv('UTF-8', 'cp874', 'รหัส'), 1, 0, 'C', true);
            $pdf->Cell(26, 10, iconv('UTF-8', 'cp874', 'ผู้ใช้'), 1, 0, 'C', true);
            $pdf->Cell(26, 10, iconv('UTF-8', 'cp874', 'รหัสผ่าน'), 1, 0, 'C', true);
            $pdf->Cell(28, 10, iconv('UTF-8', 'cp874', 'ชื่อ'), 1, 0, 'C', true);
            $pdf->Cell(26, 10, iconv('UTF-8', 'cp874', 'ตำเเหน่ง'), 1, 0, 'C', true);
            $pdf->Cell(26, 10, iconv('UTF-8', 'cp874', 'คำถาม'), 1, 0, 'C', true);
            $pdf->Cell(26, 10, iconv('UTF-8', 'cp874', 'คำตอบ'), 1, 0, 'C', true);
            ...
            foreach ($re as $k => $row) {
                ...
                $pdf->SetFont('THSarabun', '', 14);
                $pdf->Cell(8);
                $pdf->Cell(26, 10, iconv('UTF-8', 'cp874', $k + 1), 1, 0, 'C', true);
                $pdf->Cell(26, 10, iconv('UTF-8', 'cp874', $row["user"]), 1, 0, 'C', true);
                $pdf->Cell(26, 10, iconv('UTF-8', 'cp874', $row["pass"]), 1, 0, 'C', true);
                $pdf->Cell(28, 10, iconv('UTF-8', 'cp874', $row["name"]), 1, 0, 'C', true);
                $pdf->Cell(26, 10, iconv('UTF-8', 'cp874', $row["status"]), 1, 0, 'C', true);
                $pdf->Cell(26, 10, iconv('UTF-8', 'cp874', $row["question"]), 1, 0, 'C', true);
                $pdf->Cell(26, 10, iconv('UTF-8', 'cp874', $row["answer"]), 1, 0, 'C', true);
                $pdf->Ln();
            }
            ...
            class PDF extends FPDF
            {
                ...
                function Header()
                {
                    ...
                    $this->Cell(65);
                    // Title
                    $this->Cell(80, 10, iconv('UTF-8', 'cp874', 'รายงานสรุปข้อมูลพยากรณ์ยอดขาย (รายวัน)'), 1, 0, 'C');
                    // Line break
                    $this->Ln(20);
                }
            ...
            $pdf = new PDF();
            $pdf->SetXY(100, 50);
            $title = 'รายงานสรุปข้อมูลพยากรณ์ยอดขาย (รายวัน)';
            $pdf->SetTitle($title, true);
            ...
            class PDF extends FPDF
            {
                ...
                function Header()
                {
                    ...
                    $this->Cell(65);
                    // Title
                    $this->Cell(80, 10, iconv('UTF-8', 'cp874', 'รายงานสรุปข้อมูลพยากรณ์ยอดขาย (รายเดือน)'), 1, 0, 'C');
                    // Line break
                    $this->Ln(20);
                }
            ...
            class PDF extends FPDF
            {
                ...
                function Header()
                {
                    ...
                    $this->Cell(65);
                    // Title
                    $this->Cell(80, 10, iconv('UTF-8', 'cp874', 'รายงานสรุปข้อมูลพยากรณ์ยอดขาย (รายปี)'), 1, 0, 'C');
                    // Line break
                    $this->Ln(20);
                }
