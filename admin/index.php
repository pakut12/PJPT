        ...
        <div class="container mt-5">
            <div class="card text-center col-5 mx-auto shadow-lg">
                ...
                <div class="card-body">
                    ...
                    <button type="submit" class="btn btn-success w-100 btn-sm"><i class="bi bi-box-arrow-in-right"></i> OK</button>
                    <div class="mt-3"></div>

                    <hr>
                    <a href="../index.php"><button type="button" class="btn btn-primary w-100 btn-sm">
